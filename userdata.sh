...
CHEF_SERVER_NAME="ED-Chef-Automate" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="ed-chef-automate-jwlknvojwfyk2w1j.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
