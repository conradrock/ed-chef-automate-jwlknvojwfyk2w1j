<powershell>
 ...
 $env:CHEF_SERVER_NAME = "ED-Chef-Automate" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "ed-chef-automate-jwlknvojwfyk2w1j.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
